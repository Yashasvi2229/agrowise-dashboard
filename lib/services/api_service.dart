...
class ApiService {
  ...
  String _generateAnalysisText(String crop, String disease, String language) {
    final templates = {
      ...
      'pa': 'ਖੋਜਿਆ ਗਿਆ: $crop $disease ਤੋਂ ਪ್ରਭਾਵਿਤ। ਇਹ ਇੱਕ ਆਮ ਬਿਮਾਰੀ ਹੈ ਜੋ ਫਸਲ ਦੀ ਸਿਹਤ ਅਤੇ ਉਪਜ ਨੂੰ ਪ્ਰਭਾਵਿਤ ਕਰਦੀ ਹੈ। ਫੈਲਣ ਨੂੰ ਰੋਕਣ ਲਈ ਤੁਰੰਤ ਕਾਰਵਾਈ ਦੀ ਸਿਫਾਰਸ਼ ਕੀਤੀ ਜਾਂਦੀ ਹੈ।',
    };
